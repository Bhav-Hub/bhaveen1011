...
# class Simulation:
#     def __init__(self, model, memory, traffic_gen, sumo_cmd, gamma, max_steps, green_duration, yellow_duration, num_states, num_actions, training_epochs):
#         self._model = model
#         self._memory = memory
...
#         traci.trafficlight.setPhase("TL", phases[action_number])
